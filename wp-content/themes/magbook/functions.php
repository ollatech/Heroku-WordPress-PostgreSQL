...
function magbook_setup() {
	 ...
	 */
	add_theme_support( 'post-thumbnails' );
	add_image_size( 'magbook-featured-image', 600, 425, true );
	...
	if(!class_exists('Magbook_Plus_Features')){
		class Magbook_Customize_upgrade extends WP_Customize_Control {
			public function render_content() { ?>
				<a title="<?php esc_html_e( 'Review Us', 'magbook' ); ?>" href="<?php echo esc_url( 'https://wordpress.org/support/view/theme-reviews/magbook/' ); ?>" target="_blank" id="about_magbook">
				<?php esc_html_e( 'Review Us', 'magbook' ); ?>
				</a><br/>
				<a href="<?php echo esc_url( 'https://themefreesia.com/theme-instruction/magbook/' ); ?>" title="<?php esc_html_e( 'Theme Instructions', 'magbook' ); ?>" target="_blank" id="about_magbook">
				<?php esc_html_e( 'Theme Instructions', 'magbook' ); ?>
				</a><br/>
				<a href="<?php echo esc_url( 'https://tickets.themefreesia.com/' ); ?>" title="<?php esc_html_e( 'Support Tickets', 'magbook' ); ?>" target="_blank" id="about_magbook">
...
if ($magbook_header_display == 'header_logo' || $magbook_header_display == 'header_text' || $magbook_header_display == 'show_both' || is_active_sidebar( 'magbook_header_banner' )) {
	...
	echo '<div class="logo-bar"> <div class="wrap"> ';
		if ($magbook_header_display == 'header_logo' || $magbook_header_display == 'header_text' || $magbook_header_display == 'show_both') {
