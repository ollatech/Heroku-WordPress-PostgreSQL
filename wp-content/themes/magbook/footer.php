				...
				<?php 
				 ...
				 if ( is_active_sidebar( 'magbook_footer_options' ) ) :
					...
					<a title="<?php echo esc_attr( get_bloginfo( 'name', 'display' ) ); ?>" target="_blank" href="<?php echo esc_url( home_url( '/' ) ); ?>"><?php echo get_bloginfo( 'name', 'display' ); ?></a> | 
									...
									<?php  echo '&copy; ' . date_i18n(__('Y','magbook')) ; ?> <a title="<?php echo esc_attr__( 'WordPress', 'magbook' );?>" target="_blank" href="<?php echo esc_url( 'https://wordpress.org' );?>"><?php esc_html_e('WordPress','magbook'); ?></a>
								</div>
				<?php endif; ?>
