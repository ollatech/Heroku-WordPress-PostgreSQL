...
class Magbook_category_box_two_column_Widgets extends WP_Widget {
	...
	function form($instance) {
		...
		<p>
			...
			<input id="<?php echo $this->get_field_id('title2');?>" name="<?php echo $this->get_field_name('title2');?>" type="text" value="<?php echo esc_html($title2);?>" />
		</p>
	...
	function update($new_instance, $old_instance) {
		...
		$instance['title2'] = esc_html($new_instance['title2']);
		$instance['link'] = esc_url($new_instance['link']);
		$instance['link2'] = esc_url($new_instance['link2']);
		$instance[ 'number' ] = absint( $new_instance[ 'number' ] );
		$instance[ 'category' ] = esc_attr($new_instance[ 'category' ]);
		$instance[ 'category2' ] = esc_attr($new_instance[ 'category2' ]);
		$instance[ 'box_layout' ] = esc_attr($new_instance[ 'box_layout' ]);
		return $instance;
	}
